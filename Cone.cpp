...
void Cone::genCircle(bool _isBottom, glm::vec3 _pos, glm::vec3 _norm, glm::vec3 _radi, glm::vec2 _angles, int& _indCount) {
...
void Cone::genWall(glm::vec3 _startPos, glm::vec3 _endPos, glm::vec3 _startRadi, glm::vec3 _endRadi, glm::vec2 _angles, int& _indCount) {
	float angle1 = _angles.x;
	float angle2 = _angles.y;
...
void Cone::genCone(glm::vec3 _startPos, glm::vec3 _endPos, glm::vec3 _startRadius, glm::vec3 _endRadius, bool _doingBottomCircle, bool _doingTopCircle, int& _indCount) {
	// Seeding random;
	srand(seed);
...
void Cone::setTopRadius(glm::vec3 _topRadius) {
	topRadius = _topRadius;
	setLevel(level);
}

void Cone::setBottomRadius(glm::vec3 _bottomRadius) {
	bottomRadius = _bottomRadius;
	setLevel(level);
}
...
void Cone::setVBOandEBO(std::string msg) {
